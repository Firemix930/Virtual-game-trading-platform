 ...
 * @LastEditTime: 2020-11-12 11:37:01
 * @Description: file that implements the home page function
 * @FilePath: \VSLibrary\Team Work E\static\js\app\index.js
 */
...
define(["jquery", "vue", "vue-resource", "publicTip", "swiper-4.1.6.min", "public"], function($, Vue, vueResource, publicTip, Swiper, public) {
    ...
    $(function() {
        ...
        $('#signoutHref').on('click', function() {
            publicTip.showConfirm('Are you sure to log out?', function() {
            ...
            methods: {
                ...
                search: function(isLoadMore, tipKey, ot) {
                    ...
                    if (!that.key || that.key.trim() == '') {
                        that.loading = false;
                        publicTip.showAlert("Search keywords cannot be empty");
                        return;
                    }
