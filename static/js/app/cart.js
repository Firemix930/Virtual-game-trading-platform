 ...
 * @LastEditTime: 2020-11-12 11:37:54
 * @Description: file that implements the shopcart page function
 * @FilePath: \VSLibrary\Team Work E\static\js\app\cart.js
 */
    ...
    $(function() {
        ...
        $("#cart-all").click(function() {
            if ($(this).prop('checked')) {
                ...
                if (isLessStock) {
                    publicTip.showTipForStr("There is shortage of goods in stock");
                }
            } else {
                $("input[name=cartpro]").each(function() {
        ...
        $("input[type=checkbox]").click(function() {
            ...
            if (id != 'cart-all') {
                ...
                if (parseInt(count) > parseInt(stock)) {
                    publicTip.showAlert('The goods are in short stock', null, function() {
        ...
        $(".wy-dele").click(function() {
            ...
            publicTip.showConfirm('Confirm to delete this item?', function() {
